...
BEST_MODEL_PATH = BASE_DIR / "best_model_binary_efficientnetv3.keras"
FINAL_MODEL_PATH = BASE_DIR / "efficientnetb0_binary_final.keras"
...
def export_journal_friendly_report():
    ...
    with open(REPORT_TXT_PATH, "w", encoding="utf-8") as f:
        ...
        f.write("              v\n")
        f.write("+-----------------------------+\n")
        f.write("| EfficientNetB0 Backbone   |\n")
        ...
        f.write(
            ...
            "was applied during training to improve generalization. The model used EfficientNetB0 pretrained on ImageNet "
