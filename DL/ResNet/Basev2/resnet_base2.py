...
REPORT_TXT_PATH = BASE_DIR / "training_report_resnet50.txt"
...
def export_journal_friendly_report():
    ...
    with open(
        ...
        f.write("6. Final Classification Report\n")
        f.write("--------------------------------\n")
