...
MODEL_NAME = "HSV Color Histogram + Logistic Regression"
...
OUTPUT_DIR = BASE_DIR / "hsv_logistic_regression_base_outputs"
OUTPUT_DIR.mkdir(exist_ok=True)

MODEL_PATH = OUTPUT_DIR / "hsv_logistic_regression_base_model.joblib"
REPORT_TXT_PATH = OUTPUT_DIR / "hsv_logistic_regression_base_report.txt"
...
print("\nTraining HSV Histogram + Logistic Regression model...")
...
plt.title("Confusion Matrix - HSV Histogram + Logistic Regression")
plt.tight_layout()
...
print("\nBase ML HSV Histogram + Logistic Regression training completed.")
