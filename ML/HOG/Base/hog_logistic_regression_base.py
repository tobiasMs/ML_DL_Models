...
OUTPUT_DIR = BASE_DIR / "hog_logistic_regression_base_outputs"
OUTPUT_DIR.mkdir(exist_ok=True)

MODEL_PATH = OUTPUT_DIR / "hog_logistic_regression_base_model.joblib"
REPORT_TXT_PATH = OUTPUT_DIR / "hog_logistic_regression_base_report.txt"
CONFUSION_MATRIX_PATH = OUTPUT_DIR / "hog_logistic_regression_confusion_matrix.png"
...
def visualize_augmentation(paths, labels):
    ...
    augmentation_path = OUTPUT_DIR / "hog_logistic_regression_augmentation_sample.png"
...
print("\nTraining HOG + Logistic Regression model...")
