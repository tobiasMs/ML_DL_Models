...
OUTPUT_DIR = BASE_DIR / "hog_svm_base_outputs"
OUTPUT_DIR.mkdir(exist_ok=True)

MODEL_PATH = OUTPUT_DIR / "hog_svm_base_model.joblib"
REPORT_TXT_PATH = OUTPUT_DIR / "hog_svm_base_report.txt"
CONFUSION_MATRIX_PATH = OUTPUT_DIR / "hog_svm_confusion_matrix.png"
...
print("\nBase ML HOG + SVM training completed.")
