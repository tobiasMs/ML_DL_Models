...
MODEL_NAME = "Optimized LBP + Random Forest"
...
OUTPUT_DIR = BASE_DIR / "lbp_random_forest_opt_outputs"
OUTPUT_DIR.mkdir(exist_ok=True)

MODEL_PATH = OUTPUT_DIR / "lbp_random_forest_opt_model.joblib"
REPORT_TXT_PATH = OUTPUT_DIR / "lbp_random_forest_opt_report.txt"
