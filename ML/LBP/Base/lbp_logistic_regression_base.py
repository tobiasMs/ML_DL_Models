...
MODEL_NAME = "LBP + Logistic Regression"
...
OUTPUT_DIR = BASE_DIR / "lbp_logistic_regression_base_outputs"
OUTPUT_DIR.mkdir(exist_ok=True)

MODEL_PATH = OUTPUT_DIR / "lbp_logistic_regression_base_model.joblib"
REPORT_TXT_PATH = OUTPUT_DIR / "lbp_logistic_regression_base_report.txt"
CONFUSION_MATRIX_PATH = OUTPUT_DIR / "lbp_logistic_regression_confusion_matrix.png"
...
def visualize_augmentation(paths, labels):
    ...
    augmentation_path = OUTPUT_DIR / "lbp_logistic_regression_augmentation_sample.png"
...
print("\nTraining LBP + Logistic Regression model...")
...
plt.title("Confusion Matrix - LBP + Logistic Regression")
plt.tight_layout()
