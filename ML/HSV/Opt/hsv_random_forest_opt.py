...
MODEL_NAME = "Optimized HSV + Random Forest"
...
OUTPUT_DIR = BASE_DIR / "hsv_random_forest_opt_outputs"
OUTPUT_DIR.mkdir(exist_ok=True)

MODEL_PATH = OUTPUT_DIR / "hsv_random_forest_opt_model.joblib"
REPORT_TXT_PATH = OUTPUT_DIR / "hsv_random_forest_opt_report.txt"
