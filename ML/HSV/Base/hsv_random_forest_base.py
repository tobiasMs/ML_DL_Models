...
MODEL_NAME = "HSV Color Histogram + Random Forest"
...
OUTPUT_DIR = BASE_DIR / "hsv_random_forest_base_outputs"
OUTPUT_DIR.mkdir(exist_ok=True)

MODEL_PATH = OUTPUT_DIR / "hsv_random_forest_base_model.joblib"
REPORT_TXT_PATH = OUTPUT_DIR / "hsv_random_forest_base_report.txt"
CONFUSION_MATRIX_PATH = OUTPUT_DIR / "hsv_random_forest_confusion_matrix.png"
...
def visualize_augmentation(paths, labels):
    ...
    augmentation_path = OUTPUT_DIR / "hsv_random_forest_augmentation_sample.png"
...
print("\nTraining HSV Color Histogram + Random Forest model...")
...
plt.title("Confusion Matrix - HSV Color Histogram + Random Forest")
plt.tight_layout()
